...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackMissingModule() { throw new Error("Cannot find module \"./src/css/main.scss\""); }());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlobalBox = __webpack_require__(158);

	var _GlobalBox2 = _interopRequireDefault(_GlobalBox);

	_react2['default'].render(_react2['default'].createElement(_GlobalBox2['default'], null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Channel = __webpack_require__(159);

	var _Channel2 = _interopRequireDefault(_Channel);

	var _MessageBox = __webpack_require__(163);

	var _MessageBox2 = _interopRequireDefault(_MessageBox);

	var GlobalBox = _react2['default'].createClass({
	    displayName: 'GlobalBox',
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'div',
	                { id: 'panel', className: 'col-md-3 no-float' },
	                _react2['default'].createElement(
	                    'h3',
	                    null,
	                ...
	                _react2['default'].createElement(_Channel2['default'], { url: '/channels/' }),
	                _react2['default'].createElement(
	                    'h3',
	                    null,
	                ...
	                _react2['default'].createElement(_Channel2['default'], { url: '/users' })
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChannelsAction = __webpack_require__(161);

	var _ChannelsAction2 = _interopRequireDefault(_ChannelsAction);
	...
	var Channel = _react2['default'].createClass({
	    ...
	    handleClick: function handleClick(id) {
	        _ChannelsAction2['default'].pushIdChannel(id);
	    },
	    componentDidMount: function componentDidMount() {
	        $.ajax({
	            url: this.props.url,
	    ...
	    render: function render() {
	        var ChannelNode = this.state.data.map(function (channel) {
	            return _react2['default'].createElement(
	                'li',
	                { onClick: this.handleClick.bind(this, channel.id), key: channel.id },
	                channel.name
	            );
	        }, this);
	        return _react2['default'].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChannelsStore = __webpack_require__(162);

	var _ChannelsStore2 = _interopRequireDefault(_ChannelsStore);

	var ChannelsAction = {
	    pushIdChannel: function pushIdChannel(id) {
	        _ChannelsStore2['default'].pushIdChannel(id);
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageList = __webpack_require__(164);

	var _MessageList2 = _interopRequireDefault(_MessageList);

	var _MessageForm = __webpack_require__(166);
	...
	var MessageBox = _react2['default'].createClass({
	    ...
	    getStateFromStore: function getStateFromStore() {
	        return _ChannelsStore2['default'].getState();
	    },
	    getInitialState: function getInitialState() {
	    ...
	    */
	    componentDidMount: function componentDidMount() {
	        _ChannelsStore2['default'].onChange = this.onChange;
	    },
	    render: function render() {
	        console.log(this.state);
	        return _react2['default'].createElement(
	            'div',
	            { id: 'display', className: 'col-md-9 no-float' },
	...
	var MessageForm = _react2["default"].createClass({
	    ...
	    render: function render() {
	        return _react2["default"].createElement(
	            ...
	            _react2["default"].createElement("input", { type: "text", className: "form-control", placeholder: "Write your QQ here.." })
	        );
	    }
	});
